...
const MigrateUsers = () => {
    ...
    const {createMOs, progressValue: createMOsProgress, maxProgress: maxCreateMOsProgress} = useCreateMOs(postMessage, postTimedMessage, postError, settings.emailSuffix, settings.isCrossRegional)
    const {configureMOs} = useConfigureMOs(postMessage, postTimedMessage, postError, settings.emailSuffix)
    const {createQueues, progressValue: createQueuesProgress, maxProgress: maxCreateQueueProgess} = useCreateQueues(postMessage, postTimedMessage, postError, settings.isCrossRegional)
    ...
    const {createLEs, progressValue: createLEsProgress, maxProgress: maxCreateLEsProgress} = useCreateLEs(postMessage, postTimedMessage, postError, settings.emailSuffix, settings.isCrossRegional)
