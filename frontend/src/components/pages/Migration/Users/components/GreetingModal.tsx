...
export const GreetingModal = (props: {isOpen: boolean, onClose: () => void}) => {
    ...
    return (
        <Modal size='xl' opened={isOpen} onClose={onClose} withCloseButton={false}>
            ...
            <Text>Please read through the lsit below and read the <a style={{textDecoration: "none"}} target="_blank" referrerPolicy="no-referrer" href="https://docs.google.com/document/d/1NPOAVj8PtRguiNT1JgQRbpYddefc_fFhu6KN0JGvKFA/edit?usp=sharing">Migration Tool Intro</a> if you haven't yet.</Text>
