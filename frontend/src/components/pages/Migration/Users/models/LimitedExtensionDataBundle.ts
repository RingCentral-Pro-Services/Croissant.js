...
export class LimitedExtensionDataBundle implements ExcelFormattable {
    ...
    toExcelRow(): string[] {
        return [
            ...
            this.extendedData!.devices![0].emergencyServiceAddress.customerName,
            this.extendedData!.devices![0].emergencyServiceAddress.street,
            this.extendedData!.devices![0].emergencyServiceAddress.street2,
            this.extendedData!.devices![0].emergencyServiceAddress.city,
            this.extendedData!.devices![0].emergencyServiceAddress.state,
            this.extendedData!.devices![0].emergencyServiceAddress.zip,
            this.extendedData!.devices![0].emergencyServiceAddress.country,
